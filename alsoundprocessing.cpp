                                ...
                                const ALValue & timeStamp)
{
  ...
  for(int channelInd = 0 ; channelInd < nbOfChannels ; channelInd++)
  {
    for(int i = 0 ; i < nbOfSamplesByChannel ; i++)
    {
      ...
      if (channelInd == index_r) // Front micro
      {
  ...
  float ratio = fMicsEnergy[index_r] / fMicsEnergy[index_l];
  ...
  if (fMicsEnergy[index_l] > energy_left_treshold || fMicsEnergy[index_r]>energy_right_treshold)
  {
  ...
  // std::cout << " Left  = " <<  fMicsEnergy[index_l] << "      Right  = " << fMicsEnergy[index_r] << std::endl<< "      Front  = " << fMicsEnergy[3] << std::endl;
  //std::cout << "MaxValueFront  = " << maxValueFront << std::endl;
  //std::cout << "Ratio R/L = " <<  ratio << std::endl;
  std::cout << "E-l= " <<  fMicsEnergy[index_l] << std::endl;
  std::cout << "E-r= " <<  fMicsEnergy[index_r] << std::endl;
